 ...
 * @since [*next-version*]
 */
class StringableSplitCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Util\String\StringableSplitCapableTrait';
    ...
    /**
     * Tests that `_stringableSplit()` works as expected.
     *
     * @since [*next-version*]
     */
    public function testStringableSplit()
    {
        ...
        $result = $_subject->_stringableSplit($input, $separator);
